...
# ---------------- CONFIG ----------------
MODELS_DIR = "."
MODEL1_PATH = os.path.join(MODELS_DIR, "model1_xray_filterCNN.h5")
...
class XrayClassifierApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        try:
            ...
            print("Model1 exists:", os.path.exists(MODEL1_PATH))
            print("Model2 exists:", os.path.exists(MODEL2_PATH))
