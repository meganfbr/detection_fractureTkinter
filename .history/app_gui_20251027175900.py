...
def is_xray_image(img_path):
    ...
    s_thr = adaptive_stats["sat_mean"] + 2 * adaptive_stats["sat_std"]
    b_thr_low = adaptive_stats["bright_mean"] - 3 * adaptive_stats["bright_std"]
    b_thr_high = adaptive_stats["bright_mean"] + 3 * adaptive_stats["bright_std"]
    c_thr_low = adaptive_stats["contrast_mean"] - 2 * adaptive_stats["contrast_std"]

    return sat < s_thr and b_thr_low < bright < b_thr_high and contrast > c_thr_low
