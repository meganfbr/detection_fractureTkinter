...
# ======================================================
# ⚙️ DETEKSI GAMBAR X-RAY (BALANCED - ANTI FOTO SELFI, MASIH IZIN X-RAY BIRU)
# ======================================================
def is_xray_image(img_path):
    ...
    # 4️⃣ Deteksi X-ray biru pudar (warna khas X-ray digital)
...
## ======================================================
# ⚙️ DETEKSI GAMBAR X-RAY (VERSI LEBIH TOLERAN)
# ======================================================
def is_xray_image(img_path):
    img = cv2.imread(img_path)
    if img is None or adaptive_stats is None:
