...
MODEL2_PATH = os.path.join(MODELS_DIR, "TfractureCNNRev_model.keras")
...
class XrayClassifierApp(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Sistem Deteksi Fraktur Tulang Berbasis CNN")
        self.resize(950, 720)
        ...
        right.addWidget(QtWidgets.QLabel("<b>Confusion Matriks (Dinamis)</b>"))
        self.cm_canvas = QtWidgets.QLabel("Masukan Gambar Dahulu")
    ...
    def reset_ui(self):
        ...
        self.cm_canvas.setText("Masukan Gmabar Xray Melihat Confusion Matrix")
    ...
    def run_prediction(self, img_path):
        ...
        if "non" in class1_name.lower():
            QtWidgets.QMessageBox.warning(
                ...
                "🖼️ Gambar bukan X-ray.\nSilakan input kembali gambar X-ray yang valid."
            )
